report 50137 "Inventory Aging New Bucket"
{
    DefaultLayout = RDLC;
    //RDLCLayout = './Item Age Composition - Value.rdlc';
    ApplicationArea = All;
    Caption = 'Inventory Aging New Buckets';
    ...
    begin
        ...
        // ExcelBuf.AddColumn(FORMAT(PeriodStartDate[5]) + ' To ', FALSE, '', TRUE, FALSE, TRUE, '', ExcelBuf."Cell Type"::Text);
        // ExcelBuf.AddColumn(FORMAT(PeriodStartDate[1]), FALSE, '', TRUE, FALSE, TRUE, '', ExcelBuf."Cell Type"::Text);
        ...
        // ExcelBuf.AddColumn(FORMAT(PeriodStartDate[1]) + ' To ', FALSE, '', TRUE, FALSE, TRUE, '', ExcelBuf."Cell Type"::Text);
        // ExcelBuf.AddColumn(FORMAT(PeriodStartDate[2]), FALSE, '', TRUE, FALSE, TRUE, '', ExcelBuf."Cell Type"::Text);
        ...
        // ExcelBuf.AddColumn(FORMAT(PeriodStartDate[2]) + ' To ', FALSE, '', TRUE, FALSE, TRUE, '', ExcelBuf."Cell Type"::Text);
        ...
        // ExcelBuf.AddColumn(FORMAT(PeriodStartDate[3]) + ' To ', FALSE, '', TRUE, FALSE, TRUE, '', ExcelBuf."Cell Type"::Text);
