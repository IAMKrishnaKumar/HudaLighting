report 50159 "General Project Status"
{
    ...
    begin
        ...
        ExcelBuf.AddInfoColumn(REPORT::"General Project Status", FALSE, FALSE, FALSE, FALSE, '', ExcelBuf."Cell Type"::Number);
        ExcelBuf.NewRow;
    ...
    begin
        if UseRequestPage then// To use same report to send excel in email - In that case GetExcelInToStea is being used
            CreateExcelbook;
    end;
    ...
    begin
        ExcelBuf.NewRow();
        ExcelBuf.AddColumn('', FALSE, '', FALSE, FALSE, FALSE, '', ExcelBuf."Cell Type"::Text);//OA Number
        ExcelBuf.AddColumn('', FALSE, '', FALSE, FALSE, FALSE, '', ExcelBuf."Cell Type"::Text);//OA Date
        ExcelBuf.AddColumn('', FALSE, '', FALSE, FALSE, FALSE, '', ExcelBuf."Cell Type"::Text);//Amount Inc. VAT
        ExcelBuf.AddColumn('', FALSE, '', FALSE, FALSE, false, '', ExcelBuf."Cell Type"::Text);//Sales Person
        ExcelBuf.AddColumn('', FALSE, '', FALSE, FALSE, false, '', ExcelBuf."Cell Type"::Text);//LPO No.
        ExcelBuf.AddColumn('', FALSE, '', FALSE, FALSE, false, '', ExcelBuf."Cell Type"::Text);//Customer No.
        ExcelBuf.AddColumn('', FALSE, '', FALSE, FALSE, false, '', ExcelBuf."Cell Type"::Text);//Customer Name
        ExcelBuf.AddColumn('', FALSE, '', FALSE, FALSE, false, '', ExcelBuf."Cell Type"::Text);//Project Name
        ExcelBuf.AddColumn('', FALSE, '', FALSE, FALSE, false, '', ExcelBuf."Cell Type"::Text);//Currency Code
        ExcelBuf.AddColumn('', FALSE, '', FALSE, FALSE, false, '', ExcelBuf."Cell Type"::Text);//Payment Terms
        ExcelBuf.AddColumn('', FALSE, '', FALSE, FALSE, false, '', ExcelBuf."Cell Type"::Text);//Item No.
        ExcelBuf.AddColumn('', FALSE, '', FALSE, FALSE, false, '', ExcelBuf."Cell Type"::Text);//Type
        ExcelBuf.AddColumn('', FALSE, '', FALSE, FALSE, false, '', ExcelBuf."Cell Type"::Text);//Brand
        ExcelBuf.AddColumn('', FALSE, '', FALSE, FALSE, false, '', ExcelBuf."Cell Type"::Text);//Vendor Article No.
        ExcelBuf.AddColumn('', FALSE, '', FALSE, FALSE, false, '', ExcelBuf."Cell Type"::Text);//Quantity
        ExcelBuf.AddColumn('', FALSE, '', FALSE, FALSE, false, '', ExcelBuf."Cell Type"::Text);//PO Reservation
        ExcelBuf.AddColumn('', FALSE, '', FALSE, FALSE, false, '', ExcelBuf."Cell Type"::Text);//Inv Reservation
        ExcelBuf.AddColumn('', FALSE, '', FALSE, FALSE, false, '', ExcelBuf."Cell Type"::Text);//Received Qty
        ExcelBuf.AddColumn('', FALSE, '', FALSE, FALSE, false, '', ExcelBuf."Cell Type"::Text);//Qty Shipped
        ExcelBuf.AddColumn('', FALSE, '', FALSE, FALSE, false, '', ExcelBuf."Cell Type"::Text);//Unit Price
        ExcelBuf.AddColumn('', FALSE, '', FALSE, FALSE, false, '', ExcelBuf."Cell Type"::Text);//Total Price
        ExcelBuf.AddColumn('', FALSE, '', FALSE, FALSE, false, '', ExcelBuf."Cell Type"::Text);//Balance Not Received
        ExcelBuf.AddColumn('', FALSE, '', FALSE, FALSE, false, '', ExcelBuf."Cell Type"::Text);//Balance Not Delivered
        ExcelBuf.AddColumn(PurchaseOrderNo, FALSE, '', FALSE, FALSE, false, '', ExcelBuf."Cell Type"::Text);//Purchase Order No.
        if PurchaseOrderNo = '' then begin
            ExcelBuf.AddColumn('', FALSE, '', FALSE, FALSE, false, '', ExcelBuf."Cell Type"::Text);//Purchase Order Amount Inc. VAT
            ExcelBuf.AddColumn(DeliveryNoteNo, FALSE, '', FALSE, FALSE, false, '', ExcelBuf."Cell Type"::Text);//Delivery Note
            if DeliveryNoteNo = '' then begin
                ExcelBuf.AddColumn(DeliverDateL, FALSE, '', FALSE, FALSE, false, '', ExcelBuf."Cell Type"::Text);//Delivery Date
                if DeliverDateL = '' then begin
                    ExcelBuf.AddColumn('', FALSE, '', FALSE, FALSE, false, '', ExcelBuf."Cell Type"::Text);//Landed Cost
                    ExcelBuf.AddColumn('', FALSE, '', FALSE, FALSE, false, '', ExcelBuf."Cell Type"::Text);//Total Landed Cost
                    ExcelBuf.AddColumn(SalesInvoiceNo, FALSE, '', FALSE, FALSE, false, '', ExcelBuf."Cell Type"::Text);//Sales Invoice
                    if SalesInvoiceNo = '' then begin
                        ExcelBuf.AddColumn(PSIDate, FALSE, '', FALSE, FALSE, false, '', ExcelBuf."Cell Type"::Text);//Invoice Date
                        if PSIDate = '' then begin
                            ExcelBuf.AddColumn('', FALSE, '', FALSE, FALSE, false, '', ExcelBuf."Cell Type"::Text);//Invoice Amount Inc. VAT
                            ExcelBuf.AddColumn('', FALSE, '', FALSE, FALSE, false, '', ExcelBuf."Cell Type"::Text);//Advance
                        end;
                    end;
                end;
            end;
