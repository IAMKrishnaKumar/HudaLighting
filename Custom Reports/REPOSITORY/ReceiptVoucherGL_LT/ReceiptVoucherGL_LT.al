report 50124 ReceiptVoucherGL_LT
{
    DefaultLayout = RDLC;
    RDLCLayout = 'Custom Reports\REPOSITORY\ReceiptVoucherGL_LT\ReceiptVoucherGL_LT.rdl';
    ...
    dataset
    {
        dataitem("G/L Entry"; "G/L Entry")
        {
            ...
            var
                ...
                RecPDCIssue: Record "PDC Receipt";
            ...
            begin
                ...
                if RecCustPostingGroup.GET('DOMESTIC') THEN begin
                    if "G/L Account No." = RecCustPostingGroup."PDC Receipt Account" then
                        CurrReport.Skip();
                end;
                ...
                if TotalAmt < 0 then begin
                    ...
                    IF AmtInwrd12 = '' THEN
                        AmtInwrd12 := 'ZERO';
                    InitTextVariable;
                    FormatNoText(Amount_Words, TotalAmt * -1, '');
                    Text := Amount_Words[1];
