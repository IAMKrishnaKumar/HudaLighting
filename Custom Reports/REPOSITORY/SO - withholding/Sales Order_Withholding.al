report 50143 "Sales Order Withholding"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'Custom Reports\REPOSITORY\SO - withholding\Sales Order report.rdlc';
    ...
    dataset
    {
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            begin
                ...
                TotalAmt := "Sales Header"."Amount Including VAT" - GLDeductionAmount;//WithholdingTax
    ...
    var
        ...
        Ins2: Label 'Please, issue checks in favor of Bayt Al Tawreed Trading LLC ';
