report 60010 "Check Report BLOM BANK"
{
    // version NAVW114.00

    DefaultLayout = RDLC;
    PreviewMode = PrintLayout;
    RDLCLayout = 'Custom Reports\REPOSITORY\Check Report\Blom Bank_Final.rdl';
                        ...
                        IF NOT TestPrint THEN BEGIN
                            WITH GenJnlLine DO BEGIN
                                ...
                                if GenJnlLine."Document No." <> '' then
                                    CheckLedgEntry."Check No." := GenJnlLine."Document No."//UseCheckNo;
                                else
                ...
                begin
                    IF NOT TestPrint THEN BEGIN
                        ...
                        IF ApplyMethod <> ApplyMethod::MoreLinesOneEntry THEN BEGIN
                            ...
                            GenJnlLine3."Check Date" := GenJnlLine."Posting Date";//check date
                            if GenJnlLine."Document No." = '' then
                                GenJnlLine3."Document No." := UseCheckNo;
