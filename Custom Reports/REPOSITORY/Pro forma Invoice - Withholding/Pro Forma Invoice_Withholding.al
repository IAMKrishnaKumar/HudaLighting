report 50146 "Proforma Invoice Withholding"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'Custom Reports\REPOSITORY\Pro forma Invoice - Withholding\Proforma Invoice report.rdlc';
    Caption = 'Proforma Invoice Withholding';
    ...
    dataset
    {
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            column(Project_Reference; "Sales Header"."Project Reference")
            {
            }
            ...
            dataitem("Sales Line"; "Sales Line")
            {
                ...
                column(VATPercentage; "Sales Line"."VAT %")
                {

                }
                column(Vendor_Article_No; Itemcode)//"Sales Line"."Vendor Article No")
                {
                }
                column(Description_SalesLine; DescriptionText)//"Sales Line".Description)
                {
                }
                column(Quantity_SalesLine; LineQuantity)//"Sales Line".Quantity)
                {
                }
                ...
                begin
                    ...
                    GLSetup.GET;
                    if ("Sales Line".Type = Type::"G/L Account") AND ("Sales Line"."No." = GLSetup."With Holding Tax Payable GL") then
                        CurrReport.Skip();
                    ...
                    if "Sales Line".Type = "Sales Line".Type::Item then begin
                        ...
                        //  ItemCode := '';//"Sales Line"."No.";//Item code not required in case of G/L and charge
            ...
            begin
                ...
                GLDeductionAmount := RecSalesLine."Amount Including VAT";
                ...
                RecSalesLine.SetRange("Document No.", "No.");
                RecSalesLine.SetRange(Type, RecSalesLine.Type::"G/L Account");
                RecSalesLine.SetRange("No.", GLSetup."With Holding Tax Payable GL");
                if RecSalesLine.FindSet() then;
                RecSalesLine.CalcSums("Amount Including VAT");
                ...
                Clear(tvar);
                Clear(TotalAmt);
                TotalAmt := "Sales Header"."Amount Including VAT" - GLDeductionAmount;
    ...
    var
        ...
        ReportCaption: Label 'PROFORMA INVOICE';
        SPName: Text;
        SPEmail: Text;
        IsDraft: Boolean;
        ...
        OANumberCaption: Label 'رقم المستند';
        ...
        Sodate_cap: Label 'Date';
        SONo_Cap: Label 'Document No.';
        CusRefNo_cap: Label 'Cust.Ref.No.';
