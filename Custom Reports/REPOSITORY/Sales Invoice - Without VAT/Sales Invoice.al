report 50150 "Sales Invoice Without VAT"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'Custom Reports\REPOSITORY\Sales Invoice - Without VAT\Sales Invoice Report.rdlc';
        ...
        dataitem("Sales Header"; "Sales Invoice Header")
        {
            ...
            dataitem("Sales Line"; "Sales Invoice Line")
            {
                ...
                begin
                    ...
                    //Withholding
                    GLSetup.GET;
                    if ("Sales Line".Type = Type::"G/L Account") AND ("Sales Line"."No." = GLSetup."With holding Tax Receivable GL") then
                        CurrReport.Skip();
